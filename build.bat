...
REM cl -MTd -Od -nologo -Feasset_packer -EHa- -Gm- -GR- -fp:fast -Oi -WX -W4 -wd4996 -wd4100 -wd4189 -wd4127 -wd4201 -DWIN32=1 -I../lib -I../src ../src/asset_packer.cpp shell32.lib user32.lib gdi32.lib && asset_packer.exe
